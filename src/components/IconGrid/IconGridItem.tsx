  ...
  return (
    ...
    >
      ...
      <p>
        ...
        {isPragmatic && <span className="badge pragmatic" style={{ background: '#FFFF00', color: '#1A2B44', borderRadius: '50%', width: 10, height: 10, display: 'inline-block', marginLeft: 6, verticalAlign: 'middle' }}>•</span>}
      </p>
    </motion.button>
  );
};
